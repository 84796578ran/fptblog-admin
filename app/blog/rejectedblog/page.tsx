...
import { getRejectedBlogs } from "@/apis/blog"; // Đảm bảo đường dẫn đúng
...
function RejectedBlogsPage() {
  ...
  const handleGetRejectedBlogs = async () => {
    try {
      const access_token = getCookie("accessToken");
      if (access_token) {
        const response = await getRejectedBlogs(access_token);
